        ...
        <div className="victory">
          ...
          >
            ...
            <VictoryAxis
              ...
              style={{
                tickLabels: { backgroundColor: "red" },
                axisLabel: { right: 50 },
              }}
      ...
      <div className="test">
        <div className="victory">
          <VictoryChart
            ...
            padding={{ left: 100, bottom: 100, top: 50, right: 50 }}
          >
            <VictoryScatter data={monoCharacteristics} y="a" />
            <VictoryAxis
              dependentAxis
              axisLabelComponent={<VictoryLabel dy={-30} />}
              style={{
      ...
      <div className="test">
        <div className="victory">
          <VictoryChart
            ...
            padding={{ left: 100, bottom: 100, top: 50, right: 50 }}
          >
            <VictoryScatter data={poliCharacteristics} y="a" />
            <VictoryAxis
              dependentAxis
              axisLabelComponent={<VictoryLabel dy={-30} />}
              style={{
      ...
      <div className="test">
        <div className="victory">
          <VictoryChart
            ...
            padding={{ left: 100, bottom: 100, top: 50, right: 50 }}
          >
            <VictoryScatter data={amphoCharacteristics} y="a" />
            <VictoryAxis
              dependentAxis
